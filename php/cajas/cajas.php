        ...
        <div class="row centrado">
          ...
          <div class="col-xs-6 col-lg-6">
            <div class="row">
              ...
              <div class="col-xs-8 col-lg-8"><a id="modal_guardar" href="javascript:void(0)" class="btn btn-mio btn-block">Nueva caja registradora</a></div>
              <div class="col-xs-2 col-lg-2"></div>
            </div>
          </div>
        </div>
