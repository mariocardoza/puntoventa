...
<div id="page-content">
    ...
    <div class="content-header">
        <ul class="nav-horizontal text-center">
            ...
            <li>
                <a href="../productos/productos.php"><i class="gi gi-shopping_bag"></i> Productos</a>
            </li>
            <li>
    ...
    <div class="row text-center">
        <div class="col-sm-6 col-lg-3">
            <a href="javascript:void(0)" class="widget widget-hover-effect2">
                <div class="widget-extra themed-background">
                    <h4 class="widget-content-light"><strong>Ventas</strong> en el día</h4>
                </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="javascript:void(0)" class="widget widget-hover-effect2">
                <div class="widget-extra themed-background-dark">
                    <h4 class="widget-content-light"><strong>Próximos</strong> a vencer</h4>
                </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="javascript:void(0)" class="widget widget-hover-effect2">
                <div class="widget-extra themed-background-dark">
                    <h4 class="widget-content-light"><strong>Ganancias</strong> diarias</h4>
                </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <a href="javascript:void(0)" class="widget widget-hover-effect2">
                <div class="widget-extra themed-background-dark">
                    <h4 class="widget-content-light"><strong>Ganancias</strong> Mensuales</h4>
                </div>
                <div class="widget-extra-full"><span class="h2 themed-color-dark animation-expandOpen">$ 4.250</span></div>
            </a>
        </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    ...
                    <h2><strong>Clientes</strong> frecuentes</h2>
                </div>
