        ...
        <div class="row centrado">
          ...
          <div class="col-sm-4 col-lg-4">
            <div class="row">
              ...
              <div class="col-sm-8 col-lg-8"><a href="javascript:void(0)" id="modal_guardar" class="btn btn-mio btn-block">Nueva opción</a></div>
              <div class="col-sm-2 col-lg-2"></div>
          </div>
          </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).on("input","#busqueda", function(e){
      ...
      $(document).on("click","#btn_guardar", function(e){
            var valid=$("#fm_opcion").valid();
            if(valid){
              modal_cargando();
                var datos=$("#fm_opcion").serialize();
                console.log(datos);
                $.ajax({
                    url:'json_opciones.php',
                    type:'POST',
