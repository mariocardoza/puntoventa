...
class MYPDF extends TCPDF {
	...
	public function Header() {
        ...
        $img_file = K_PATH_IMAGES.'ccf.jpg';
...
//if($id_orden!="") {
    ...
    /*$sql="
		...
		FROM
			...
			INNER JOIN t_marca AS marca ON marca.id = vehiculo.marca
...
foreach ($procesos as $lista) {
	...
	$txt = substr(strtoupper($lista['proceso']), 0,65);
...
foreach ($repuestos as $lista) {
	...
	$txt = substr(strtoupper($lista['item']), 0,65);
...
if($_GET['sector']=="Gran Contribuyente" && $sumas >= 100){
