...
$sql_venta="SELECT c.*,m.nombre as n_mesa, DATE_FORMAT(c.fecha,'%d/%m/%Y') as dia_comanda,DATE_FORMAT(fecha,'%H:%m:%s') as hora_comanda FROM tb_comanda as c INNER JOIN tb_mesa as m ON m.codigo_oculto=c.mesa WHERE c.codigo_oculto='$comanda'";
