...
$vencidos=Notificacion::llenar_vencidos();
$stock=Notificacion::llenar_stock();
$cuantos_s=Notificacion::cuantos_stock();
$cuantos=Notificacion::cuantos_vencidos();
/**
 * page_head.php
 *
 * Author: pixelcave
    ...
    <div id="page-container"<?php if ($page_classes) { echo ' class="' . $page_classes . '"'; } ?>>
        ...
        <div id="main-container">
            ...
            <header class="navbar<?php if ($template['header_navbar']) { echo ' ' . $template['header_navbar']; } ?><?php if ($template['header']) { echo ' '. $template['header']; } ?>">
                ...
                <ul class="nav navbar-nav-custom">
                    <!-- Main Sidebar Toggle Button este es el que se ve -->
                    <li>
                        <a href="javascript:void(0)" onclick="App.sidebar('toggle-sidebar');this.blur();">
                            <i class="fa fa-bars fa-fw"></i>
                        </a>
                ...
                <ul class="nav navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="gi gi-warning_sign"></i> <i class="fa fa-angle-down"></i>
                            <span class="label label-primary label-indicator animation-floating"><?php echo $cuantos[0][cuantos] ?></span>
                        </a>
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            <li class="dropdown-header text-center">Notificaciones</li>
                            <li>
                                <a href="javascript:void(0)">
                                    <span class="badge pull-right"><b><?php echo $cuantos[0][cuantos]; ?></b></span>
                                    Próximos a caducar
                                </a>
                            </li>
                            <?php print($vencidos); ?>
                            <li>
                                <a href="javascript:void(0)">
                                    <span class="badge pull-right"><b><?php echo $cuantos_s[0][cuantos]; ?></b></span>
